    ...
    >
          ...
          <div className="absolute left-4 md:left-6 top-[80px] md:top-[150px] w-[calc(100%-32px)] md:w-[calc(100%-48px)] max-w-[643px] z-10">
            ...
            <p className="text-white text-sm md:text-base leading-normal mb-2 md:mb-4 max-w-[643px] hidden md:block">
              ...
              <span className="font-normal">
                {" "}
                Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia
                menyampaikan, langkah ini dilakukan sebagai bentuk....
              </span>
            </p>
      ...
      <div className="w-full max-w-[1140px] mx-auto mt-10 px-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-darkcolor text-xl font-bold">
            detikcom Categories
          </h2>
        ...
        <div className="flex gap-4 mb-6 justify-center flex-wrap">
          {[
            ...
            <div
              key={index}
              className="inline-flex p-2 px-3 justify-center items-center rounded-3xl bg-white shadow-sm border border-gray-100 min-w-[100px] h-8"
            >
              <img
                src={src}
                alt={`Category ${index + 1}`}
                className={index === 2 ? "w-[83px] h-4" : "w-[70px] h-[14px]"}
              />
            </div>
          ))}
        </div>
      ...
      {/* Main Content Area */}
      <div className="w-full max-w-[1140px] mx-auto mt-10 flex flex-col gap-6 px-4">
        {/* Left Content */}
        <div className="flex-1 max-w-[1140px]">
          {/* Featured Article */}
          ...
          {/* Latest News */}
          <h2 className="text-darkcolor text-2xl font-bold mb-6">
            Berita terkini
          </h2>
            ...
            {[
              {
                ...
                excerpt:
                  "Jakarta - Isu reshuffle kabinet 15 Juni 2022 menguat dengan Istana....",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/d3ed17b378023e652f5356d3b433b4251115d65a?width=534",
                title: "Naik Candi Borobudur Nggak Jadi Bayar Rp 750.000...",
                excerpt:
                  "Jakarta - Menteri PUPR Basuki Hadimuljono menyatakan.....",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/2726f9666437d51cd4ab114844e7e132e10b6010?width=536",
                title:
                  "Pernyataan Resmi Kahitna Terkait Kasus Narkoba Andrie Bayuajie",
                excerpt:
                  "Jakarta - Menteri PUPR Basuki Hadimuljono menyatakan.....",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/9cf858dd677c35711aeaa94f315ebb5a5de6e4d3?width=538",
                title:
          ...
          <div className="space-y-6">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/2b3ae2b2d4e91f90e91d998b9804664c2bd3816d?width=922",
                source: "DetikOto",
                date: "juni 14, 2022",
                title: "2 Toyota Alphard di garasi Zulkifli Hasan",
                excerpt:
                  "Jakarta - Zulkifli Hasan santer dikabarkan bakal dilantik menjadi Menteri Perdagangan menggantikan Muhammad Lutfi.",
                time: "19 jam yang lalu",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/a426822c38266b5d524d7e965f4d3f4118e03d75?width=534",
                title:
                  "Terhalang Tembok SMKN 69 Jakarta, Sri Jalan Kaki Usai Operasi di RS",
                excerpt:
                  "Jakarta - LINE Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia menyampaikan....",
                time: "19 jam yang lalu",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/9ac59ccd496dc140a9334ad8826e83b468ac5799?width=532",
                title:
                  "Harap Bersabar! Ruas Jl HR Rasuna Said Jaksel Ini Masih Rusak",
                excerpt:
                  "Jakarta - LINE Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia menyampaikan....",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/e5357cabb067297b7e5e725eb654cec7f16e419d?width=532",
                title:
                  "Lebaran Sudah Berlalu, Kabel-kabel Mampang Jaksel Masih belum masuk SJUT",
                excerpt:
                  "Jakarta - LINE Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia menyampaikan....",
              ...
              <div key={index}>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="py-4">
                    {article.source && (
                      <div className="flex items-center gap-1 mb-2">
                        <span className="text-textgray-light text-sm font-bold">
                          {article.source}
                        </span>
                        <span className="text-textgray-light text-sm">
                          | {article.date}
                        </span>
                      </div>
                    )}
        ...
        <div className="w-full lg:w-[558px] lg:max-w-[558px] mt-8 lg:mt-0">
          ...
          {/* Popular Tags */}
          <div className="mb-6">
            <h3 className="text-detikblue text-2xl font-bold mb-4">
              Tag Terpopuler #
            </h3>
            ...
            <div className="text-darkcolor text-base font-bold leading-normal whitespace-pre-line">
              #reshuffle kabinet #Iko uwais #erina gudono #pemilu 2024 #allo
              bank
            </div>
          </div>
        </div>
      ...
      {/* Video Section */}
      <div className="w-full max-w-[1392px] mx-auto mt-6 mb-6 bg-detikred rounded-2xl md:rounded-3xl relative overflow-hidden p-4 md:p-6 border border-solid font-normal">
        <svg
          width="386"
          height="759"
          viewBox="0 0 386 759"
        ...
        <div className="relative z-10">
          ...
          {/* Main Video */}
          <div
            className="relative w-full h-[250px] mb-8 bg-cover bg-center rounded-lg"
            style={{
              backgroundImage:
                "url('https://api.builder.io/api/v1/image/assets/TEMP/aec3b3d3e373d76b3b86f39d489b21383e5c785d?width=1504')",
            }}
          >
          ...
          <div className="relative">
            <div className="absolute left-0 bottom-0 inline-flex py-3 px-6 items-center gap-2 rounded-[25px] bg-white">
              <span className="text-detikred text-sm font-bold">
                Video Lainnya
              </span>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path
                  d="M6.42847 3.85693L11.5713 8.99978L6.42847 14.1426"
                  stroke="#BF2026"
                  strokeWidth="1.48114"
                  strokeMiterlimit="10"
                  strokeLinecap="round"
            ...
            <div className="text-white text-sm mb-8">Juni 14, 2022</div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-8 md:mt-12">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/4de8c80ca2ed7d464c79e0bf9c6e4d7b685a928d?width=534",
                duration: "01:03",
                title:
                  "Tarif Tiket Masuk Candi Borobudur Rp 750 Ribu Dibatalkan",
                date: "Juni 13, 2022",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/caee069acb100200d8506d6416a059a951d6a40b?width=534",
                duration: "00:30",
                title:
                  "Daftar Aplikasi yang Paling Sering Digunakan Orang Indonesia",
                date: "Juni 13, 2022",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/48407f4a80e29595d99010966d236be4e961a4d1?width=534",
                duration: "02:00",
                title:
                  "Serangan Balik Iko Uwais Usai Dipolisikan atas Dugaan Penganiayaan",
                date: "Juni 13, 2022",
              },
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/61aa0f60e20d18590601a4391580bd7297fb5ba8?width=534",
                duration: "01:00",
                title:
                  "Bikin Laper: Unik Banget! Ada Bakmi Ayam Merah di Kawasan Sunter",
                date: "Juni 13, 2022",
              },
            ].map((video, index) => (
              <div key={index} className="w-full">
                ...
                <div className="w-full">
                  ...
                  <div className="text-white text-sm">{video.date}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="w-full max-w-[1140px] mx-auto mt-10 flex flex-col lg:flex-row gap-6 px-4">
        <div className="flex-1 max-w-[825px]">
          ...
          <div className="space-y-6">
            {[
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/f9dac7a0f011f82738a4a462c091dceb9e777035?width=922",
                source: "DetikNews",
                date: "juni 14, 2022",
                title:
                  "Jokowi Pakai Kemeja Putih 'Indonesia Maju' di Hari Reshuffle Kabinet",
                excerpt:
                  "Jakarta - Zulkifli Hasan santer dikabarkan bakal dilantik menjadi Menteri Perdagangan menggantikan Muhammad Lutfi.",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/61a2b03ddf1ba93682e4a96ac6f0b9ea33059e22?width=534",
                title:
                  "Viral Foto Selebgram Cantik saat Ditangkap Polisi, Wajah Aslinya Jadi Sorotan",
                excerpt:
                  "Jakarta - LINE Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia menyampaikan....",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/f62346e2f8b5ad84ba6526d83e5e468da00b4680?width=532",
              ...
              {
                image:
                  "https://api.builder.io/api/v1/image/assets/TEMP/8480e9a4f46860ed3cb0c63502df84f714dfc368?width=532",
                title:
                  "Mobil Mewah Keponakan Prabowo yang Bakal Dilantik Jadi Wamenkop UKM",
                excerpt:
                  "Jakarta - LINE Today akan resmi ditutup pada 6 Juli 2022. Line Indonesia menyampaikan....",
                time: "1 jam yang lalu",
              },
              ...
              <div key={index}>
                <div className="flex flex-col md:flex-row gap-4 md:gap-6">
                  ...
                  <div
                    className={
                      index === 0
                        ? "w-full md:w-[340px] py-0 md:py-6"
                        : "flex-1 py-0 md:py-4"
                    }
                  >
                    {article.source && (
                    ...
                    <h3
                      className={`text-darkcolor font-bold leading-tight mb-3 ${index === 0 ? "text-2xl leading-9" : "text-lg leading-6"}`}
                    >
                      {article.title}
                    </h3>
                    <p className="text-textgray text-sm leading-5 mb-2">
          ...
          <div className="inline-flex py-3 px-6 items-start gap-3 rounded-3xl bg-detikblue-light mt-8">
            <span className="text-detikblue text-sm font-bold">
              Lihat selengkapnya
            </span>
          </div>
        </div>
        ...
        <div className="w-[290px]">
          {/* Popular News */}
          <h3 className="text-detikblue text-2xl font-bold mb-6">
            Berita terpopuler
          </h3>
              ...
              <div key={num} className="flex gap-2">
                ...
                <div className="flex-1">
                  <h4 className="text-darkcolor text-base font-semibold leading-6 mb-1">
                    Beda Versi Ayu Thalia Vs Nicholas Sean di Sidang soal Tidur
                    Bareng
                  </h4>
                  <div className="text-textgray-light text-sm">
      ...
      <div className="w-full max-w-[1140px] mx-auto mt-10 px-4">
        <h2 className="text-darkcolor text-2xl font-bold mb-6 text-center">
          Foto Terpopuler
        </h2>
        ...
        <div className="flex w-full relative overflow-x-auto md:overflow-visible">
          {[
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/01521fe9af85b5130bd8517ce99c52530af66e22?width=382",
            ...
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/b247dac277c10b36cf8b3222c39d910ebea23ebe?width=378",
              title: "Inggris Jadi Bulan-bulanan Hungaria",
              count: "8 Foto",
            },
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/f9624258c3311c6e89a2c8c6e4e0a3b068a52130?width=378",
              title: "8 Potret Kemeriahan PKB 2022, Pawai-IKM",
              count: "8 Foto",
            },
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/4d11a8cc24c0b6f5463ea0eb7ad2e077d5aa6976?width=378",
              title:
                "8 potret Vila sewaan atta-aurel saat pindah sementara di Bali, Mewah!",
              count: "8 Foto",
            },
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/57dcfdeeae784ec27049b5ebc92b879d948c9bb7?width=378",
              title: "Ekuador Memanas, Massa Pendemo Bakar Mobil Polisi",
              count: "10 Foto",
            },
            {
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/d8883ad834e980ad29315a0215eea9df3ad2cf4d?width=380",
              title:
                "Keren! Jembatan Kaca Sepanjang 240 Meter di Tengahnya Ada Kafe Berlian",
              count: "10 Foto",
              isLast: true,
            },
          ].map((photo, index) => (
            <div key={index} className="relative flex-shrink-0">
              <div
                className={`w-[160px] md:w-[190px] h-[220px] md:h-[266px] bg-gray-300 relative overflow-hidden ${photo.isFirst ? "rounded-l-lg" : photo.isLast ? "rounded-r-lg" : ""}`}
              >
                <img
                  src={photo.image}
                  alt={photo.title}
                ...
                <div className="absolute left-3 bottom-8 max-w-[163px]">
                  ...
                  <div className="text-white text-xs">{photo.count}</div>
                </div>
                ...
                {photo.isFirst && (
                  <div className="absolute left-1.5 top-[120px] w-[26px] h-[26px] rounded-full bg-white/50 backdrop-blur-sm flex items-center justify-center">
                    <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                      <path
                        d="M10.0894 12.1783L5.91078 7.99974L10.0894 3.82117"
                        stroke="white"
                        strokeWidth="1.213"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
                ...
                {photo.isLast && (
                  <div className="absolute right-1.5 top-[120px] w-[26px] h-[26px] rounded-full bg-white/50 backdrop-blur-sm flex items-center justify-center">
                    <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
                      <path
                        d="M5.91077 12.1783L10.0893 7.99974L5.91077 3.82117"
                        stroke="white"
                        strokeWidth="1.213"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
        ...
        <div className="flex w-[185px] h-[41px] py-3 px-10 justify-center items-center gap-1 rounded-3xl bg-detikblue-lighter mx-auto">
          <span className="text-detikblue text-center text-sm font-bold">
            Indeks berita
          </span>
          <svg width="11" height="10" viewBox="0 0 13 10" fill="none">
            <path
              d="M1 4.33114C0.630601 4.33114 0.331144 4.6306 0.331144 5C0.331144 5.3694 0.630601 5.66886 1 5.66886V4.33114ZM12.473 5.47295C12.7342 5.21175 12.7342 4.78825 12.473 4.52705L8.21638 0.270473C7.95517 0.00926876 7.53168 0.00926876 7.27047 0.270473C7.00927 0.531678 7.00927 0.955174 7.27047 1.21638L11.0541 5L7.27047 8.78362C7.00927 9.04483 7.00927 9.46832 7.27047 9.72953C7.53168 9.99073 7.95517 9.99073 8.21638 9.72953L12.473 5.47295ZM1 5.66886H12V4.33114H1V5.66886Z"
              fill="#244B9C"
            />
          </svg>
        </div>
