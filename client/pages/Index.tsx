...
const Index = () => {
  return (
    <div className="w-full max-w-[1440px] mx-auto bg-white font-sans text-sm" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      {/* Video Section */}
      <div className="w-full max-w-[1392px] mx-auto mt-6 mb-6 bg-detikred rounded-2xl md:rounded-3xl relative overflow-hidden p-4 md:p-6 border border-solid font-light">
